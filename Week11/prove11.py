...
with open("life-expectancy.csv") as full_sheet:
   ...
   print(f'The max life expectancy was in {filtered_highest["entity"]} with {filtered_highest["life_exp"]}')
   print(f'The min life expectancy was in {filtered_lowest["entity"]} with {filtered_lowest["life_exp"]}')
